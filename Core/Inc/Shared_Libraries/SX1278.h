...
#define PACKET_RECEIVED_SPI_TRANSFER 3
...
#define LoRa_Frequency_MHzToF(f) ((f* 524288 / 32 ) + 1638) //1638 to match with old channels (->frequency is not exactly as defined)
